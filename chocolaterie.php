...
<head>
    ...
    <title>Chocolaterie Robert</title>
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="chocolaterie.php"><img class="img-circle" style="margin-top:-25px;" src ="assets/img/robert.png" width=110px/></a>
            </div>

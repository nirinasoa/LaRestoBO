                     ...
                     <li>
                        <a class="active-menu-top" href="#"><i class="fa fa-bicycle "></i>Forms <span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level collapse in">
                             ...
                             <li>
                                <a  class="active-menu" href="form.php"><i class="fa fa-desktop "></i>Basic </a>
                            </li>
                             <li>
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
               <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <form role="form" method="post" action="modification.php">
                        ...
                        <div class="">
                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                ...
                                <div>
                                    <span class="btn btn-file btn-success"><span class="fileupload-new"></span><span class="fileupload-exists">Change</span><input name="images" type="file"></span>
                                    <a href="#" class="btn btn-danger fileupload-exists" data-dismiss="fileupload">Remove</a>
                                        ...
                                        <div class="form-group">
                                            <label>Image</label>
                                            <input class="form-control" type="text" value="<?php echo $p->image ?>">
										</div>
                                 <div class="form-group">
                                            <label>Titre</label>
                                            <input class="form-control" type="text" value="<?php echo $p->titre ?>">
                                     
                                        </div>
                                            <div class="form-group">
                                            <label>Description</label>
                                            <textarea class="form-control" rows="3"><?php echo $p->description ?></textarea>
                                        </div>
										<div class="form-group">
                                 ...
                                 <?php } ?>
                                        <button type="submit" class="btn btn-info">Términer</button>
